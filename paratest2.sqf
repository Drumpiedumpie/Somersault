...
//_arrAreas=[sq_3];
/*
//_spawnparachute = "NonSteerable_Parachute_F";
//_spawnparachute = "LIB_NonSteerable_Parachute";
*/

//_spawnparachute = "B_Parachute";
//_spawnparachute = "B_LIB_US_Type5";
//_spawnparachute = "B_LIB_US_TypeA3";	\\	IFA3
//_spawnparachute = "B_LIB_US_Type5";	\\	IFA3 Big one
//_spawnparachute = "B_Parachute";	\\	Vanilla
_spawnparachute = "ACE_NonSteerableParachute";	//	ACE
